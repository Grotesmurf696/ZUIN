...
Om de materiaalkeuzes te onderbouwen werden usability tests afgenomen met kinderen uit de Woudlopertak van de scouts (max. 12 jaar). De test was opgedeeld in 3 boards:
 
- **Board 1**: bandjes (aanvoelen rond de pols, likertschaal)
- **Board 2**: afwerking van de behuizing (materiaal en finish, likertschaal)
- **Board 3**: tactiele ring (patroon en draaibeweging, likertschaal)
Na elk board kozen de kinderen hun favoriet en lichtten ze dit toe.
