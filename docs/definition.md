...
Vervolgens werd dit idee fysiek uitgewerkt door drie quick and dirty prototypes. In wave 1 werden deze prototypes gevalideerd door een user feedback session (n=5).  
...
Om wave 1 vlot te kunnen starten, werd er gebeld met Jeroen Bourgonjon, impactcoördinator en expert digitale innovatie voor mens en samenleving vanuit Comon. Hier werd afgetoetst wat de goede leeftijdscategorie is voor onze doelgroep. Hij vertelde dat kinderen vanaf 5 jaar al gehoord hebben van het begrip energieverbruik. De doelgroep werd dus gedefineerd op kinderen van de lagere school (5 - 12 jaar). 
...
> De 2e wave staat centraal rond intuïtief gebruik. Op 6/12/2025 werden enkele testen afgenomen met kinderen in de Krook in Gent. De testpersonen kregen de verschillende interfaces voorzich en twee branden de lampen. Ze werden gevraagd om telkens 3 taken uit te voeren:
...
Specifiek per interface was bij UI1 de eerste interactie verwarrend door de onduidelijkheid van het brand-icoontje. Ook de swipe-interactie werd pas spontaan toegepast bij de tweede poging. De kinderen gaven aan dat ze graag een personalisatie-optie willen. 
...
De interface bevat een monstertje die door zoomorphisme de kinderen begeleidt en vertrouwd maakt met de interface. Deze geeft feedback om zo de kinderen extra te motiveren. 
...
Deze requirements zijn uitgezet in een PRD. 
